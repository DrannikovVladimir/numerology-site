...
**Контент, готовый к публикации:**
- Опубликовать «Квадрат Пифагора» — статья готова с картинками, положить в
  content/published/ и прогнать node autopilot/update-planned-urls.js
