...
7. **Финальный CTA-блок перед футером на главной** — сознательно отложен
8. **Изображения для главной** — hero-картинка и 6 иконок блока "Что расскажет о вас нумерология" ещё не сгенерированы и не положены в site/public/images/ (промпты под Flux готовы, см. историю чата)
