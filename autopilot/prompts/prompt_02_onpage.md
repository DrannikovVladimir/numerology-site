...
- hub_id — берётся точно из поля hub_id в semantic_clusters.json — через дефисы, не транслитерировать самостоятельно. Пример: "angelskie-chisla", не "angelskie_chisla"
